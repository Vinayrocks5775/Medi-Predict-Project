...
@st.cache_resource
def load_model():
    model = joblib.load('https://symptomstorage.blob.core.windows.net/gold/model.pkl')
    le = joblib.load('https://symptomstorage.blob.core.windows.net/gold/label_encoder.pkl')
